...
def create_parser():
    ...
    parser.add_argument("--n_epochs", default=80, type=int, help="Select the number of epochs for GNN training")
    ...
    parser.add_argument('--infer', action='store_true', help='Run model in inference mode')
    parser.add_argument('--getsplits', action='store_true', help='Return the splits as 3 csv files')
